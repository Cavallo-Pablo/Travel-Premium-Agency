...
@Component({
  selector: 'app-login-user-buy',
  templateUrl: './login-user-buy.component.html',
  styleUrls: ['./login-user-buy.component.css']
})
export class LoginUserBuyComponent {
